...
#8.New Method
nohup python train_New.py --gpu 0 --arch vgg19 --outdir save_New_V6_atten2 --factor 8 --atten 3 > New_vgg19_atten3.out 2>&1 &
nohup python train_New.py --gpu 1 --arch resnet32 --outdir save_New_V6_atten2 --factor 8 --atten 3 > New_resnet32_atten3.out 2>&1 &
nohup python train_New.py --gpu 2,3 --arch wide_resnet20_8 --outdir save_New_V6_atten2 --factor 8 --atten 3 > New_wide_resnet20_8_atten3.out 2>&1 &

nohup python train_New.py --gpu 1 --arch vgg19 --outdir save_New_V6_atten2 --factor 8 --atten 1 > New_vgg19_atten3.out 2>&1 &
nohup python train_New.py --gpu 0 --arch resnet32 --outdir save_New_V6_atten2 --factor 8 --atten 1 > New_resnet32_atten3.out 2>&1 &
nohup python train_New.py --gpu 4,5 --arch wide_resnet20_8 --outdir save_New_V6_atten2 --factor 8 --atten 1 > New_wide_resnet20_8_atten3.out 2>&1 &

nohup python train_New.py --gpu 4 --tea_avg --arch vgg19 --outdir save_New_V6_avg2 --atten 3 > New_vgg19_avg.out 2>&1 &
nohup python train_New.py --gpu 5 --tea_avg --arch resnet32 --outdir save_New_V6_avg2 --atten 3 > New_resnet32_avg.out 2>&1 &
nohup python train_New.py --gpu 6,7 --tea_avg --arch wide_resnet20_8 --outdir save_New_V6_avg2 --atten 3 > New_wide_resnet20_8_avg.out 2>&1 &
