...
nohup python change_LWR.py --gpu 1 --model vgg19 > change_LWR_vgg19.out 2>&1 &
nohup python change_LWR.py --gpu 2 --model wide_resnet20_8 > change_LWR_wide_resnet20_8.out 2>&1 &
