...
def dataloader(data_name="CIFAR100", batch_size=64, num_workers=8, root='./Data'):
    ...
    if data_name == 'CIFAR10':
        ...
        trainset = torchvision.datasets.CIFAR100(root=root, train=True, download=True, transform=transforms.ToTensor())
        ...
        trainset = torchvision.datasets.ImageFolder(traindir, transform=transforms.ToTensor())
