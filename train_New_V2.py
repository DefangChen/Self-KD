...
class LWR(torch.nn.Module):
    ...
    def loss_fn_with_kl(self, logits: Tensor, y_true: Tensor, batch_idx: Tensor):
        ...
        loss2 = self.tau ** 2 * F.kl_div(F.log_softmax(logits / self.tau, dim=self.softmax_dim),
...
parser.add_argument("--outdir", type=str, default="save_New_V2")
...
if __name__ == '__main__':
    ...
    lwr = LWR(k=args.k, update_rate=0.9, num_batches_per_epoch=len(dataset1) // args.batch_size,
